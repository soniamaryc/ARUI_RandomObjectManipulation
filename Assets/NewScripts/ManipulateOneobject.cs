...
/// </summary>
public class ManipulateOneobject : MonoBehaviour
{
	/// <summary>
	...
	//public Vector3 objectEulerAngle;
	...
	public void Update()
	{
		...
		if (targetObject1 != null) {
			...
			//objectEulerAngle = andyObject.transform.eulerAngles;
			//objectEulerAngle = targetObject1.transform.eulerAngles;
			...
			angleTurned = targetObject1.transform.eulerAngles.y - anchor1.transform.eulerAngles.y; //How much the angle adjusted by the user..
			...
			if (Frame.Raycast ((float)Screen.width/2,(float)Screen.height/2, raycastFilter, out hit)) {   
				...
				if ((hit.Trackable is DetectedPlane) && Vector3.Dot (FirstPersonCamera.transform.position - hit.Pose.position,hit.Pose.rotation * Vector3.up) < 0) {
					...
					if (count == 1) {
						...
						targetObject1 = Instantiate (pickPrefab, hit.Pose.position, anchor1.transform.rotation); // Initial orientation is aligned with the marker orientation. 
						//targetObject1.transform.Rotate(0, k_ModelRotation, 0, Space.Self);
						targetObject1.transform.parent = anchor2.transform;
						Debug.Log ("objectPoseX_anchor:" + anchor2.transform.position.x * 100 + ", objectPoseY_anchor:" + anchor2.transform.position.y * 100 + ", objectPoseZ_anchor:" + anchor2.transform.position.z * 100);
						//count = count + 1;
					}
		...
		//............................. Sending the Object Orientation about Y-axis and the  scale value in Z azix ( width of the object).
		//.....................................................................................................
			...
			if (doneOnce && ButtonSend) {
				...
				Debug.Log ("objectPoseX:" + targetObject1.transform.position.x * 100 + ", objectPoseY:" + targetObject1.transform.position.y * 100 + ", objectPoseZ:" + targetObject1.transform.position.z * 100);
				string pickX = targetObject1.transform.position.x.ToString ();
				string pickY = targetObject1.transform.position.y.ToString ();
				string pickZ = targetObject1.transform.position.z.ToString ();
				...
				// Object width and orientation......

				string scaleValue = objectScale.x.ToString ();
				//Debug.Log ("Object Scale:" + scaleValue);
				string angleValue = angleTurned.ToString ();

				btmodule.sendMsg (scaleValue);
				btmodule.sendMsg (angleValue);    
