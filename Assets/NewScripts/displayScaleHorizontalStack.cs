...
public class displayScaleHorizontalStack : MonoBehaviour
{
	...
	private HorizontalStacking controllerscript;
	private Vector3 virtualcubescale;


	void Start()
	{
		controllerscript = GetComponent<HorizontalStacking>();
		...
		stackHeight = controllerscript.stackHeight;
	...
	void Update()
	{
		...
		stackText.text =  "Height:"+ (stackHeight*100).ToString()+"cm";
